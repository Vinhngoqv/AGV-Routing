...
% global f fg
% fg = figure();
% f = axes('xlim',[-5 105],'ylim',[-15 50],'zlim',[-1 10]);
...
A = xlsread('toa_do.xlsx','Toa do','B2:D2310');
x = A(:,1);
y = A(:,2);
z = A(:,3);
for i=1:425
...
% text(x(120)+0.1, y(120)+0.3, z(120),'120');
% text(x(522)+0.1, y(522)+0.3, z(522),'522');
...
% for i = 1:523
%     t = int2str(i);
%     text(x(i)+0.1, y(i)+0.3, z(i)+0.1,t,'FontSize',8);
% end
% 
% for i = 2224:2309
%     t = int2str(i);
